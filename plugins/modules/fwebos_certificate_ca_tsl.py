...
DOCUMENTATION = """
---
module: fwebos_certificate_ca_tsl
description:
...
obj_url = '/api/v2.0/system/certificate.tslca'
del_url = '/api/v2.0/cmdb/system/certificate.tsl-ca'
...
def add_obj_tsl_ca(module, connection):
    payload1 = {}
...
def add_obj(module, connection):
    if(module.params['type'] == 'localPC'):
        return add_obj_tsl_ca(module, connection)
