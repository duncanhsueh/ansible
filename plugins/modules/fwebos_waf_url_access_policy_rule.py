...
def add_obj(module, connection):
    ...
    url_access_rule_name = module.params['url_access_rule_name']

    payload = {
        'data':
        {
            'url-access-rule-name': url_access_rule_name,
        },
    }
...
def main():
    ...
    if 'errcode' in str(result):
        ...
        if result['res']['results']['errcode'] == -3 or result['res']['results']['errcode'] == -5  or result['res']['results']['errcode'] == -7102:
            result['failed'] = False
